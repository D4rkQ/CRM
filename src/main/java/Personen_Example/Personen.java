 ...
 * Changed by E. Ammann, 2014
 */

public class Personen {

    private static final String BASE_URL = "http://www.reutlingen-university.de/ontologies/personen.owl";
    private static final String FILE_LOCATION = "personen.owl";
